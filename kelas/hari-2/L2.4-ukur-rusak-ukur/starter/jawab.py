...
def periksa_sitasi(jawaban, jumlah_potongan):
    ...
    # TODO L2.4-1: Pemeriksaan sitasi struktural: temukan sitasi 'hantu' (nomor di luar rentang potongan) dan hitung 'cakupan' (rasio kalimat yang ber-sitasi). Ini tak menangkap halusinasi bersitasi.
    return {"hantu": set(), "cakupan": 1.0}
...
def jawab(pertanyaan, pengguna=None, k=None, tampilkan_potongan=True):
    ...
    if pengguna and pengguna.get("peran") != "pimpinan":
        pass   # tempat menambahkan penyaring unit kerja — lihat modul A4
