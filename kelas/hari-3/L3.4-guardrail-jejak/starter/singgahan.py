...
class Singgahan:
    ...
    def kunci(self, pertanyaan, pengguna):
        ...
        # TODO L3.4-2: bila self.sertakan_izin bernilai True, sambungkan sidik
        # hak akses ke dalam kunci:
        #     bagian += "|" + izin.sidik(pengguna)
        #
        # Satu baris ini yang memisahkan cache aman dari cache yang
        # membocorkan dokumen. Sebelum dikerjakan, jalankan
        # `python singgahan.py`: KEDUA kolom peragaan akan sama-sama BOCOR,
        # karena kunci "benar" dan kunci "salah" belum ada bedanya.
