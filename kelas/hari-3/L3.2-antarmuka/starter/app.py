    ...
    with st.chat_message("assistant"):
        try:
            with st.spinner("Mencari di dokumen..."):
                # TODO L3.2-1: Panggil pipeline jawab() dengan pertanyaan, peran pengguna, dan k; kembalikan (isi, potongan, lapor) untuk ditampilkan beserta sumbernya.
                isi, potongan, lapor = ("Lengkapi pemanggilan jawab() di sini (TODO L3.2 - lihat solution/).", [], {"cakupan": 1.0, "hantu": set()})
