...
def simpul_persetujuan(keadaan: Keadaan) -> dict:
    ...
    # TODO L3.5-1: hentikan alur dan minta keputusan manusia.
    #   keputusan = interrupt({
    ...
    #   })
    #
    # Sertakan ALASAN-nya, bukan hanya jawabannya. Penyelia yang tidak diberi
    # tahu apa yang mencurigakan akan menekan 'setuju' terus-menerus, dan
    # persetujuan yang selalu 'ya' sama saja dengan tidak ada persetujuan.
    #
    # Sebelum dikerjakan, simpul ini menyetujui apa pun secara diam-diam:
    # jalankan dengan pertanyaan yang cakupan sitasinya rendah, dan jawaban
    # meragukan itu akan lolos tanpa seorang pun melihatnya.
    keputusan = None
...
def arah_periksa(keadaan: Keadaan) -> str:
    ...
    # TODO L3.5-2: kembalikan "persetujuan" bila keadaan["alasan"] ada isinya,
    # dan "catat" bila kosong. (simpul_periksa sudah mengisinya.)
    #
    # Perhatikan siapa yang memutuskan di sini: sebuah fungsi biasa, bukan
    # model. "Kapan manusia dilibatkan" adalah kebijakan organisasi — ia harus
    # bisa dibaca, diuji, dan diubah tanpa menyentuh satu pun prompt.
    #
    # Sebelum dikerjakan, TIDAK ADA yang pernah dieskalasi: jawaban dengan
    # sitasi hantu pun langsung dicatat sebagai final.
    return "catat"
