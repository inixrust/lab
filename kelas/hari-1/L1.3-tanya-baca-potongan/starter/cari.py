...
def cari_vektor(pertanyaan, k=None):
    ...
    if _basis is None:
        _basis = _buka_indeks()
    # TODO L1.3-1: Lakukan pencarian kemiripan pada indeks: similarity_search(pertanyaan, k=...). Pakai k bila diberi, jika tidak konfig.JUMLAH_AKHIR.
    raise NotImplementedError("TODO L1.3-1 - lengkapi bagian ini (lihat README / folder solution).")
