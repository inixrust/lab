...
def _pemotong() -> RecursiveCharacterTextSplitter:
    ...
    # TODO L1.2-1: Buat RecursiveCharacterTextSplitter dengan ukuran potongan, tumpang tindih, dan daftar pemisah dari konfig.
    raise NotImplementedError("TODO L1.2-1 - lengkapi bagian ini (lihat README / folder solution).")
...
def muat_semua(akar: Path = None, diam: bool = False):
    ...
    for folder in sorted(p for p in akar.iterdir() if p.is_dir()):
        ...
        for berkas in sorted(folder.rglob("*")):
            ...
            # TODO L1.2-2: Potong daftar dokumen menjadi potongan-potongan kecil dengan pemotong di atas.
            raise NotImplementedError("TODO L1.2-2 - lengkapi bagian ini (lihat README / folder solution).")
